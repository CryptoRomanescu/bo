...
pub type OutcomeUpdateSender = tokio::sync::mpsc::Sender<(
    String,
    Outcome,
    Option<f64>,
    Option<f64>,
...
pub type OutcomeUpdateReceiver = tokio::sync::mpsc::Receiver<(
    String,
    Outcome,
    Option<f64>,
    Option<f64>,
...
pub struct FeatureWeights {
    ...
    pub dex_trending: f64,
    pub dex_momentum: f64,
}
    ...
    fn default() -> Self {
        ...
        let low_activity = RegimeSpecificParameters {
            weights: FeatureWeights {
                liquidity: 0.23, // Higher weight on liquidity in low activity
                holder_distribution: 0.18,
                volume_growth: 0.09, // Lower weight as volume is low
                holder_growth: 0.13,
                ...
                dex_trending: 0.03,
                dex_momentum: 0.06, // Higher weight - momentum can signal upcoming activity
            },
            thresholds: ScoreThresholds::default(),
        };
        ...
        let bullish = RegimeSpecificParameters {
            weights: FeatureWeights {
                liquidity: 0.13,
                holder_distribution: 0.09,
                volume_growth: 0.23, // High weight on volume in bull market
                holder_growth: 0.18, // High weight on holder growth
                price_change: 0.13,  // Price momentum important
                jito_bundle_presence: 0.05,
        ...
        let bearish = RegimeSpecificParameters {
            weights: FeatureWeights {
                liquidity: 0.28,           // Very high weight on liquidity in bear market
                holder_distribution: 0.23, // Important to avoid whale dumps
        ...
        let choppy = RegimeSpecificParameters {
            weights: FeatureWeights {
                ...
                jito_bundle_presence: 0.09, // More important for execution timing
        ...
        let high_congestion = RegimeSpecificParameters {
            weights: FeatureWeights {
                ...
                holder_growth: 0.09,
                price_change: 0.09,
                jito_bundle_presence: 0.33, // Very high weight on Jito bundles for execution
